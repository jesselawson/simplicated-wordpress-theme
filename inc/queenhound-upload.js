jQuery(document).ready(function($){
	$('#author_profile_picture_button').click(function() {
		...
		tb_show('Upload an author profile picture! (from the Author Avatar plugin at Lawsonry.com)', 'media-upload.php?referer=profile&amp;type=image&amp;TB_iframe=true&amp;post_id=0', false);
		return false;
	});
